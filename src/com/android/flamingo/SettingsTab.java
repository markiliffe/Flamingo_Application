...
public class SettingsTab extends Activity implements SensorListener, OnClickListener{
...
//        bundle.putFloat("xAxis", xAxis);
//        bundle.putFloat("yAxis", yAxis);
//        bundle.putFloat("zAxis", zAxis);      
    }
    
//    static float[] getAccelerometer(){
